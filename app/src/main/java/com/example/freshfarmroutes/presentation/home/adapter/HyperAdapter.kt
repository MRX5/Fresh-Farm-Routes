...
class HyperAdapter: RecyclerView.Adapter<HyperAdapter.HyperViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HyperViewHolder {
        ...
        val binding=DataBindingUtil.inflate<HyperLayoutBinding>(inflater, R.layout.hyper_layout,parent,false)
    ...
    inner class HyperViewHolder(private val binding: HyperLayoutBinding):RecyclerView.ViewHolder(binding.root){
        @SuppressLint("Range")
